              ...
              <div class = "container">
                ...
                <table>
                 <tr>
                  ...
                  <table>
                  <tr>
                  <th style = "text-align:center;border: 3px solid #87CEFA;">ใบกำกับภาษี / ใบส่งสินค้า / ใบแจ้งหนี้ <br>TAX INVOICE / DELIVERY ORDER / INVOICE</th>
                  </tr>
                  </table>
                  </td>
                  <td style = "width: 150px;"></td>
                ...
                <br>
                <table>
                <tr><td style = "width: 350px;">นามลูกค้า '.$row["Name"].'</td>   <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>       <td>เลขที่</td><td style = "text-align:right">'.$row["ID"].'</td></tr>
...
<!-- หัวเรื่อง -->                
            <div class = "container">
              ...
              <table>
              <tr><td><h3><b>บริษัท '.$row2["Name_company"].' จำกัด</b></h3></td>      <td style = "width: 140px;"></td>       <td><table><tr><th style = "text-align:center;border: 3px solid #FF8C00;"><h4>สำหรับบริษัท</h4></th></tr></table></td></tr>
              <tr><td style = "width: 400px;">ที่อยู่ : '.$row2["Address_company"].' </td>       <td></td></tr>
              <tr><td>โทร. '.$row2["Phone_company"].' เลขประจำตัวผู้เสียภาษี '.$row2["ID_vat"].' </td>       <td></td></tr>
              </table>
              ...
              <table>
                 <tr>
                  ...
                  <table>
                  <tr>
                  <th style = "text-align:center;border: 3px solid #FF8C00;">สำเนาใบกำกับภาษี / ใบส่งสินค้า / ใบแจ้งหนี้ <br>COPY TAX INVOICE / DELIVERY ORDER / INVOICE</th>
                  </tr>
                  </table>
                  </td>
                  <td style = "width: 150px;"></td>
...
<!-- หัวเรื่อง -->                
        <div class = "container">
          ...
          <table>
          <tr><td><h3><b>บริษัท '.$row2["Name_company"].' จำกัด</b></h3></td>      <td style = "width: 140px;"></td>       <td><table><tr><th style = "text-align:center;border: 3px solid #00FF7F;"><h4>สำหรับบัญชี</h4></th></tr></table></td></tr>
          <tr><td style = "width: 400px;">ที่อยู่ : '.$row2["Address_company"].' </td>       <td></td></tr>
          <tr><td>โทร. '.$row2["Phone_company"].' เลขประจำตัวผู้เสียภาษี '.$row2["ID_vat"].' </td>       <td></td></tr>
          </table>
          <br>
          ...
          <tr>
           ...
           <table>
           <tr>
           <th style = "text-align:center;border: 3px solid #00FF7F;">สำเนาใบกำกับภาษี / ใบส่งสินค้า / ใบแจ้งหนี้ <br>COPY TAX INVOICE / DELIVERY ORDER / INVOICE</th>
           </tr>
           </table>
           </td>
           <td style = "width: 150px;"></td>
...
<!-- หัวเรื่อง -->                
        <div class = "container">
          ...
          <table>
          <tr><td><h3><b>บริษัท '.$row2["Name_company"].' จำกัด</b></h3></td>      <td style = "width: 140px;"></td>       <td><table><tr><th style = "text-align:center;border: 3px solid #9370DB;"><h4>สำหรับลูกค้า</h4></th></tr></table></td></tr>
          <tr><td style = "width: 400px;">ที่อยู่ : '.$row2["Address_company"].' </td>       <td></td></tr>
          <tr><td>โทร. '.$row2["Phone_company"].' เลขประจำตัวผู้เสียภาษี '.$row2["ID_vat"].' </td>       <td></td></tr>
          </table>
          <br>
          ...
          <tr>
           ...
           <table>
           <tr>
           <th style = "text-align:center;border: 3px solid #9370DB;">ใบเสร็จรับเงิน <br>RECEIPT</th>
           </tr>
           </table>
           </td>
           <td style = "width: 250px;"></td>
...
<!-- ตาราง --> 
              <table bgcolor ="MediumPurple">
                ...
                <br><br><br><br><br><br><br><br><br>
                <br><br><br><br><br><br><br><br><br>
                <th style = "text-align:center">'.number_format($row['bye'], 2).'</th>
                <br><br><br><br><br><br><br><br><br>
                <br><br><br><br><br><br><br><br><br>
                </tr> 
              </table>    
              <table>
              <tr><td style = "width:410px;"><table><tr><th style = "text-align:left"><h5>ตัวอักษร. ('.Convert($row['bye']).')</h5></th></tr></table></td><td style = "text-align:right">รวมเงิน&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.number_format($row['bye'], 2).' บาท</td></tr>
              </table>
<!-- ===== -->      
<br>
   <table>
     <tr><td style = "width:80px; text-align:right;"><input type = "checkbox" style = "width: 10px;"></td><td style = "text-align:left;">เงินสด</td><td style = "text-align:center"></td><td>บาท</td> <td style = "width:370px;"></td></tr>
     <tr><td style = "text-align:right;"><input type = "checkbox" style = "width: 10px;"></td><td style = "text-align:left;">เงินโอน</td><td style = "text-align:center"></td><td>บาท</td> <td></td></tr>
     </table>
     <table>
     <tr><td style = "width:80px; text-align:right;"><input type = "checkbox" style = "width: 10px;"></td><td style = "text-align:left;">เช็คธนาคาร.................</td><td style = "text-align:left;">เลขที่......................</td><td></td> <td style = "width:290px;"></td></tr>
     <tr><td></td><td style = "text-align:left;">ลงวันที่.......................</td><td style = "text-align:left;">จำนวนเงิน...............</td><td style = "text-align:left;">บาท</td> <td></td></tr>
   </table>


   <h6 style = "text-align:center;">กรณีชำระด้วยเช็ค ใบเสร็จฯ นี้จะสมบูรณ์ต่อเมื่อบริษัทฯ ได้รับเงินแล้วเท่านั้น</h6>
<table>
<tr><th style = "width: 210px; text-align:left;"><h5><br><br><br>ผู้รับเงิน<br><br>วันที่</h5></th>  <th><h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <br><br><br>ผู้รับใบเสร็จ<br><br>วันที่</h5></th>   <th style = "text-align:center"><h5>ในนาม บริษัท '.$row2["Name_company"].' จำกัด <br><br><br><br><br><br>ผู้มีอำนาจลงนาม</h5></th>  </tr>
...
<!-- หัวเรื่อง -->                
        <div class = "container">
          ...
          <table>
          <tr><td><h3><b>บริษัท '.$row2["Name_company"].' จำกัด</b></h3></td>      <td style = "width: 140px;"></td>       <td><table><tr><th style = "text-align:center;border: 3px solid #FFC0CB;"><h4>สำหรับบัญชี</h4></th></tr></table></td></tr>
          <tr><td style = "width: 400px;">ที่อยู่ : '.$row2["Address_company"].' </td>       <td></td></tr>
          <tr><td>โทร. '.$row2["Phone_company"].' เลขประจำตัวผู้เสียภาษี '.$row2["ID_vat"].' </td>       <td></td></tr>
          </table>
          ...
          <tr>
           ...
           <table>
           <tr>
           <th style = "text-align:center;border: 3px solid #FFC0CB;">สำเนาใบเสร็จรับเงิน <br>COPY RECEIPT</th>
           </tr>
           </table>
           </td>
           <td style = "width: 250px;"></td>
...
<tr><th style = "width: 210px; text-align:left;"><h5><br><br><br>ผู้รับเงิน<br><br>วันที่</h5></th>  <th><h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <br><br><br>ผู้รับใบเสร็จ<br><br>วันที่</h5></th>   <th style = "text-align:center"><h5>ในนาม บริษัท '.$row2["Name_company"].' จำกัด <br><br><br><br><br><br>ผู้มีอำนาจลงนาม</h5></th>  </tr>
            ...
            ';
                ...
                $mpdf->AddPage();
                $mpdf->WriteHTML($text4);
                $mpdf->AddPage();
                $mpdf->WriteHTML($text5);
                $mpdf->Output();
        }
    } else {
