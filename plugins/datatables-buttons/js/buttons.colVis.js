...
(function (factory) {
  ...
  $.extend(DataTable.ext.buttons, {
    // A collection of เลือกดูเฉพาะ Column buttons
    colvis: function (dt, conf) {
      return {
        extend: "collection",
        text: function (dt) {
          return dt.i18n("buttons.colvis", "เลือกดูเฉพาะ Column");
        },
    ...
    // Selected columns with individual buttons - toggle เลือกดูเฉพาะ Column
    ...
    // Single button to toggle เลือกดูเฉพาะ Column
    ...
    // Selected columns with individual buttons - set เลือกดูเฉพาะ Column
    ...
    // Single button to set เลือกดูเฉพาะ Column
    columnVisibility: {
