...
(function (factory) {
   ...
   *
   * In additional to เลือกดูเฉพาะ Column control, Responsive also has built into
  ...
  $.extend(Responsive.prototype, {
    ...
    _resize: function (forceRedraw) {
      ...
      // Set the class before the เลือกดูเฉพาะ Column is changed so event
     ...
     *
     * We don't use DataTables' เลือกดูเฉพาะ Column controls in order to ensure
     * that เลือกดูเฉพาะ Column can Responsive can no-exist. Since only IE8+ is
     ...
     * complex option given that เลือกดูเฉพาะ Column can change on the fly. Its a
